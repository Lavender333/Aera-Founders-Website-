  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center my-auto w-full max-w-md space-y-5 py-4 z-10">
        ...
        {/* AERA Brand Logo Emblem with Halo */}
        <motion.div
        ...
        >
          ...
          >
            ...
            {/* Mountain Contour inside Shield */}
            <path
            ...
            {/* Dynamic Orbital Swoosh wrapping around shield */}
            <path
        ...
        {/* Live Emergency Status Flow Ribbon */}
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* Operating Model Framework Card */}
        <motion.div
        ...
        <div className="w-full space-y-2.5 pt-1">
          ...
          {/* Network Registration Status Badge - Staggered Final Card */}
          <motion.div
            initial={{ opacity: 0, x: -16, y: 10 }}
            animate={{ opacity: 1, x: 0, y: 0 }}
            transition={{
