...
import { AlertCircle, HelpCircle, Cpu, CheckCircle2, ChevronRight, ChevronLeft } from 'lucide-react';
...
export const GenesisStory: React.FC = () => {
  ...
  const chapters: GenesisChapter[] = [
    ...
    },
    {
      ...
      number: '02',
      kicker: 'THE QUESTION',
      title: 'Ken defined the missing link.',
    ...
    },
    {
      index: '03',
      number: '03',
      kicker: 'FROM QUESTION TO PLATFORM',
      title: 'Antoinette turned the vision into a system.',
      ...
      label: 'FROM QUESTION TO PLATFORM',
      founderLine: 'Ken defined the need. Antoinette built the system.',
    },
    {
      index: '04',
      number: '04',
    ...
    <section ref={sectionRef} className="py-20 bg-[#F3F8F5] border-y border-[rgba(48,88,84,0.14)]" id="genesis">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
          <div>
            <span className="eyebrow">Ken's Founding Insight</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
          {chapters.map((ch, idx) => (
            ...
            >
              <span className={`text-xs font-mono font-black ${activeChapter === idx ? 'text-[#8CBB5D]' : 'text-[#305854]'}`}>
                {ch.number}
              </span>
              <strong className="block text-sm font-bold mt-1 leading-snug">{ch.kicker}</strong>
            </button>
          ))}
        </div>

        {/* Active Chapter Stage Card */}
        <div className="bg-white rounded-[28px] border border-[rgba(48,88,84,0.18)] p-6 sm:p-10 shadow-lg grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col gap-5">
            ...
            {/* Custom Beat / Question / Founder line */}
              ...
              <div className="p-5 rounded-2xl bg-[#305854] text-white border-l-4 border-[#8CBB5D] shadow-sm mt-2">
                ...
                {chapters[activeChapter].principles && (
                  <div className="flex flex-wrap gap-2 mt-4">
                    {chapters[activeChapter].principles?.map((p) => (
                      <span key={p} className="px-3 py-1 rounded-full bg-white text-[#305854] text-xs font-bold">
                        ✓ {p}
                      </span>
                    ))}
                  </div>
          ...
          <motion.div style={{ y: diagramY }} className="lg:col-span-6 bg-[#F3F8F5] rounded-2xl p-6 border border-[rgba(48,88,84,0.18)] min-h-[320px] flex items-center justify-center">
            ...
            {activeChapter === 1 && (
              <div className="w-full text-center flex flex-col items-center gap-4">
                ...
                <strong className="text-xl font-black text-[#305854]">Original Vision</strong>
            ...
            {activeChapter === 2 && (
              <div className="w-full grid grid-cols-3 gap-2 text-center text-xs font-bold">
                ...
                <div className="col-span-3 p-4 bg-[#305854] text-white rounded-xl font-black text-sm my-1">
                  AERA Architecture (Built by Antoinette)
                </div>
